...
public class AnjukeShanghaiRent {
	...
	public static final String SUB_SINGLE_SELECT_REGEX = "div[id=apf_id_10_blockcontainer]";
	...
	public String subSingle(String line){
		...
		Element elem = ParserUtil.parseUrlWithRegexAndResultIndex(url, SUB_SINGLE_SELECT_REGEX, 0);
		//可能会空，像怀柔就没有
		if (elem == null ){
			return "";
		}
	...
	@Test
	public void createBatchFileAnjukeShanghaiRent(){
		//用以统计总共有多少个页面
		int totalCount = 0;
	...
	public static void main(String[] args) {
		new AnjukeShanghaiRent().subSingle("http://shanghai.anjuke.com/rental/pudong/,浦东");
