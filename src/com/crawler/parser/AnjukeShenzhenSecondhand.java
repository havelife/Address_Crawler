...
public class AnjukeShenzhenSecondhand {
	public static final String CITY_PINYING = "Shenzhen";
	public static String URL_SUBDOMAIN = "shenzhen";
...
//												System.out.println("before, areaSizeTotal:" + areaSizeTotal + ", add count:" + count + ", at url:" + url);
	...
	@Test
	public void createBatchFileAnjukeShenzhenSecondhand(){
		//用以统计总共有多少个页面
		int totalCount = 0;
	...
	public static void main(String[] args) {
		new AnjukeShenzhenSecondhand().createBatchFileAnjukeShenzhenSecondhand();
