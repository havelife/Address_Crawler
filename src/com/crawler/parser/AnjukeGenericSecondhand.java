...
public class AnjukeGenericSecondhand {
	...
	public void doAllProcessInOneFunction() {
		...
		createBatchFileAnjukeGenericSecondhand();
	}
	...
	public void parseCategory4OneDistrict(){
		...
		String ROOM_NUMBUER__SELECT_REGEX =  "div[id=panel_apf_id_13]";
		
		Element elem = ParserUtil.parseUrlWithRegexAndResultIndex(PARSE_CATEGORY_URL, ROOM_NUMBUER__SELECT_REGEX, 0);
...
//												System.out.println("before, areaSizeTotal:" + areaSizeTotal + ", add count:" + count + ", at url:" + url);
	...
	@Test
	public void createBatchFileAnjukeGenericSecondhand(){
		//用以统计总共有多少个页面
		int totalCount = 0;
