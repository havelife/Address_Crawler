...
public class AnjukeAllOtherCityXiaoqu {
	...
	public static final String ALL_OTHER_CITY_FILE_PATH = "./data/parser/" + SITE_NAME_PINYING + "/" + SITE_NAME_PINYING + TYPE_PINYING + "AllOtherCityWhole.txt";
	
	
	public static ArrayList<Pair> cityAndSubdomainList;

	/*
	 * http://www.anjuke.com/index/ 上的所有其它城市，（除去 北京 上海  广州  青岛）  但是 包括  深圳
	 * */
	@Test
	public void allOtherCityWhole(){
		...
		for (Element element : elements){
			...
			if ( !(word.equals("北京")||word.equals("上海") || word.equals("广州") || word.equals("青岛"))) {
				sb.append(href);
				sb.append(",");
				sb.append(word);
				sb.append("\n");
	...
	public static void createAllOtherCityBatchJobFile(){
		...
		for (Pair pair : cityAndSubdomainList){
			AnjukeGenericXiaoqu genericXiaoqu = new AnjukeGenericXiaoqu(pair.getKey(), pair.getValue());
			genericXiaoqu.doAllProcessInOneFunction();
			System.out.println("/***************************************************************/");
	...
	public static ArrayList<String> getBatchJobFilePath4AllOtherCityXiaoqu(){
		//提取所有的城市和子域名的对应关系
		initCityAndSubdomainList();
